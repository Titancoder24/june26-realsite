...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-primary/15 bg-background/95 px-2.5 py-1.5 text-xs shadow-[0_8px_24px_rgba(0,0,0,0.1),0_0_0_1px_rgba(255,255,255,0.04)_inset] backdrop-blur-sm",
        className
      )}
    >
